...
import { 	Schema, Fragment, Slice, IProseMirrorSlice, IThingGroup, IThing, IProseMirrorNode, Transaction, Transform, ReplaceAroundStep } from "./interfaces"; 
...
export class ProseMirrorTransactionBuilder {
	...
	constructor(state: any, private readonly schema: Schema, sharedString: SharedString) { // EditorState to any
...
function adjustOffset(from: any, offset: any, value: any, insert: any, gapDistance: any) {
